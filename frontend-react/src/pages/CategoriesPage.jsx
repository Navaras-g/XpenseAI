                ...
                <Card>
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <select
                            ...
                            className="bg-slate-700 border border-slate-600 text-slate-200 rounded-lg px-3 py-1.5 text-sm focus:outline-none"
                        >
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-3 gap-3">
                                ...
                                <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                                    ...
                                    <p className="text-white font-bold text-sm mt-1">{catTxns.length}</p>
                                </div>
                            </div>

                            <ResponsiveContainer width="100%" height={160}>
                                <LineChart data={catMonthly}>
                            ...
                            return (
                                <div key={merchant}>
                                    <div className="flex justify-between text-sm mb-1">
                                        ...
                                        <span className="text-slate-400">{formatNPR(amount)}</span>
                                    </div>
